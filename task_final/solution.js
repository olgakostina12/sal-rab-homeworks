...
function sendRequest(name, phone, address, goods, sum) {
    ...
    let adress = 'ул. ' + address.street + ', ' + 'дом ' + address.house + ', ' + address.entrance + ' подъезд, ' + address.floor + ' этаж, кв '  + address.flat;
    data.order = {'address': adress, 'sum': sum};
